...
A free, open-source collection of little, useful tools.
...
- **Reading Level**: Estimate readability scores for a passage of text
- **Regex Test**: Test regular expressions against lines of text
- **Scratchpad**: Write a quick note to yourself
